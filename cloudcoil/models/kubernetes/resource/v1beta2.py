...
class DeviceAttribute(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def bools(self, value: list[bool] | None, /) -> Self:
            "BoolValues is a non-empty list of true/false values."
            return self._set("bools", value)

        def int_(self, value: int | None, /) -> Self:
            "IntValue is a number."
            return self._set("int_", value)

        def ints(self, value: list[int] | None, /) -> Self:
        ...
        def strings(self, value: list[str] | None, /) -> Self:
        ...
        def versions(self, value: list[str] | None, /) -> Self:
...
class DeviceCounterConsumption(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def compatibility_groups(self, value: list[str] | None, /) -> Self:
            ...
            return self._set("compatibility_groups", value)
    ...
    compatibility_groups: Annotated[list[str] | None, Field(alias="compatibilityGroups")] = None
    'CompatibilityGroups is a list of opaque group names for this counter set consumption.\n\nDevices that consume counters from the same counter set may only be allocated at the same time ("co-allocated") if they all share at least one common group: the intersection of the CompatibilityGroups of all co-allocated devices on that counter set must be non-empty. Devices that consume from different counter sets are never compared via this field.\n\nAn unset field, an explicit nil, and an empty list are equivalent and mean "no groups": such a device is only co-allocatable with sibling devices on the same counter set that also have no groups, and is never co-allocatable with a device that declares one or more groups.\n\nGroup names are opaque and meaningful only within the publishing driver\u0027s pool.\n\nThe maximum number of groups is 2, and the names must be unique.'
...
class DeviceDerivedAttribute(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> type["DeviceDerivedAttribute"]:
            return DeviceDerivedAttribute

        def build(self) -> "DeviceDerivedAttribute":
            return DeviceDerivedAttribute(**self._attrs)
    ...
    class BuilderContext(BuilderContextBase["DeviceDerivedAttribute.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = DeviceDerivedAttribute.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for DeviceDerivedAttribute."""
        return cls.BuilderContext()

    @classmethod
    def list_builder(cls) -> GenericListBuilder["DeviceDerivedAttribute", Builder]:
        return GenericListBuilder[DeviceDerivedAttribute, DeviceDerivedAttribute.Builder]()
...
class ExactDeviceRequest(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> type["ExactDeviceRequest"]:
            return ExactDeviceRequest

        def build(self) -> "ExactDeviceRequest":
            return ExactDeviceRequest(**self._attrs)
        ...
        def derived_attributes(
            self, value_or_callback: list[DeviceDerivedAttribute] | None, /
        ) -> "ExactDeviceRequest.Builder": ...
        ...
        def derived_attributes(
            self,
            value_or_callback: Callable[
                [GenericListBuilder[DeviceDerivedAttribute, DeviceDerivedAttribute.Builder]],
                GenericListBuilder[DeviceDerivedAttribute, DeviceDerivedAttribute.Builder]
                | list[DeviceDerivedAttribute],
            ],
            /,
        ) -> "ExactDeviceRequest.Builder": ...
        ...
        def derived_attributes(
            self, value_or_callback: Never = ...
        ) -> ListBuilderContext[DeviceDerivedAttribute.Builder]: ...

        def derived_attributes(self, value_or_callback=UNSET, /):
            ...
            if self._in_context and value_or_callback is UNSET:
                context = ListBuilderContext[DeviceDerivedAttribute.Builder]()
                context._parent_builder = self
                context._field_name = "derived_attributes"
                return context
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(DeviceDerivedAttribute.list_builder())
                if isinstance(output, GenericListBuilder):
                    value = output.build()
                else:
                    value = output
            return self._set("derived_attributes", value)
    ...
    class BuilderContext(BuilderContextBase["ExactDeviceRequest.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = ExactDeviceRequest.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for ExactDeviceRequest."""
        return cls.BuilderContext()

    @classmethod
    def list_builder(cls) -> GenericListBuilder["ExactDeviceRequest", Builder]:
        return GenericListBuilder[ExactDeviceRequest, ExactDeviceRequest.Builder]()
    ...
    count: int | None = None
    'Count is used only when the count mode is "ExactCount". Must be greater than zero. If AllocationMode is ExactCount and this field is not specified, the default is one.'
    derived_attributes: Annotated[
        list[DeviceDerivedAttribute] | None, Field(alias="derivedAttributes")
    ] = None
    "DerivedAttributes defines a set of virtual attributes computed via CEL expressions for each candidate device. These virtual attributes can be referenced in `.devices.constraints` to align and match different devices (e.g., co-allocating a GPU and a NIC on the same NUMA node) even if their drivers publish different attributes. Derived attributes are not available via `device.attributes` in the CEL environment when evaluating selector expressions.\n\nDerived attributes allow you to extract, transform, or normalize topology information (such as extracting a NUMA index from a complex topology string or renaming a vendor-specific attribute) into a common virtual attribute name at scheduling time. The scheduler then evaluates these virtual attributes exactly like static attributes when matching constraints.\n\nEvery derived attribute defined in this list must be referenced by at least one MatchAttribute or DistinctAttribute constraint in the `.devices.constraints` list.\n\nThe maximum number of derived attributes is 32.\n\nThis is an alpha field and requires enabling the DRADerivedAttributes feature gate."
...
class NodeAllocatableMapping(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> type["NodeAllocatableMapping"]:
            return NodeAllocatableMapping

        def build(self) -> "NodeAllocatableMapping":
            return NodeAllocatableMapping(**self._attrs)

        def capacity_key(self, value: str | None, /) -> Self:
            ...
            return self._set("capacity_key", value)

        @overload
        def capacity_multiplier(
            self, value_or_callback: Quantity | None, /
        ) -> "NodeAllocatableMapping.Builder": ...
        ...
        def capacity_multiplier(self, value_or_callback=UNSET, /):
            ...
            if self._in_context and value_or_callback is UNSET:
                context = Quantity.BuilderContext()
                context._parent_builder = self
                context._field_name = "capacity_multiplier"
                return context
            ...
            if callable(value_or_callback):
                ...
                if isinstance(output, Quantity.Builder):
                    ...
                    value = output
            return self._set("capacity_multiplier", value)
        ...
        def device_multiplier(self, value_or_callback=UNSET, /):
            ...
            if self._in_context and value_or_callback is UNSET:
                context = Quantity.BuilderContext()
                context._parent_builder = self
                context._field_name = "device_multiplier"
                return context
            ...
            if callable(value_or_callback):
                ...
                if isinstance(output, Quantity.Builder):
                    ...
                    value = output
            return self._set("device_multiplier", value)

    class BuilderContext(BuilderContextBase["NodeAllocatableMapping.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = NodeAllocatableMapping.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for NodeAllocatableMapping."""
        return cls.BuilderContext()

    @classmethod
    def list_builder(cls) -> GenericListBuilder["NodeAllocatableMapping", Builder]:
        return GenericListBuilder[NodeAllocatableMapping, NodeAllocatableMapping.Builder]()

    capacity_key: Annotated[str | None, Field(alias="capacityKey")] = None
    'CapacityKey references a capacity name defined as a key in the `spec.devices[*].capacity` map. When this field is set, the value associated with this key in the `status.allocation.devices.results[*].consumedCapacity` map (for a specific claim allocation) determines the base quantity for the node allocatable resource. `capacityMultiplier` must also be set and is multiplied with the base quantity. For example, if `spec.devices[*].capacity` has an entry "dra.example.com/memory": "128Gi", and this field is set to "dra.example.com/memory", then for a claim allocation that consumes { "dra.example.com/memory": "4Gi" } the base quantity for the node allocatable resource mapping will be "4Gi". The final node allocatable resource amount is `consumedCapacity[capacityKey]` * `capacityMultiplier`.'
    capacity_multiplier: Annotated[Quantity | None, Field(alias="capacityMultiplier")] = None
    'CapacityMultiplier is used as a multiplier for the allocated capacity consumed. It is only valid if `capacityKey` is set. The final node allocatable resource amount is `consumedCapacity[capacityKey]` * `capacityMultiplier`. For example, if a Device\u0027s capacity "dra.example.com/cores" is consumed, and each "core" provides 2 "cpu"s, the mapping would be: {ResourceName: "cpu", capacityKey: "dra.example.com/cores", capacityMultiplier: "2"}. If a claim consumes 8 "dra.example.com/cores", the CPU footprint is 8 * 2 = 16.'
    device_multiplier: Annotated[Quantity | None, Field(alias="deviceMultiplier")] = None
    'DeviceMultiplier is used as a multiplier for the allocated device count in the claim. The final node allocatable resource amount is `deviceCount` * `deviceMultiplier`. For example, a DRA driver representing each cache complex (CCX) as a device would have {ResourceName: "cpu", deviceMultiplier: "8"} in its `nodeAllocatableResources`. If 2 devices (CCX) are allocated to the claim, 2 * 8 = 16 CPUs would be considered as allocated. It is only valid when `capacityKey` and `capacityMultiplier` are not set.'


class NodeAllocatableOverhead(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> type["NodeAllocatableOverhead"]:
            return NodeAllocatableOverhead

        def build(self) -> "NodeAllocatableOverhead":
            return NodeAllocatableOverhead(**self._attrs)

        @overload
        def per_container(
            self, value_or_callback: Quantity | None, /
        ) -> "NodeAllocatableOverhead.Builder": ...
        ...
        @overload
        def per_container(self, value_or_callback: Never = ...) -> "Quantity.BuilderContext": ...

        def per_container(self, value_or_callback=UNSET, /):
            ...
            if self._in_context and value_or_callback is UNSET:
                context = Quantity.BuilderContext()
                context._parent_builder = self
                context._field_name = "per_container"
                return context
            ...
            if callable(value_or_callback):
                ...
                if isinstance(output, Quantity.Builder):
                    ...
                    value = output
            return self._set("per_container", value)
        ...
        @overload
        def per_pod(self, value_or_callback: Never = ...) -> "Quantity.BuilderContext": ...

        def per_pod(self, value_or_callback=UNSET, /):
            ...
            if callable(value_or_callback):
                ...
                if isinstance(output, Quantity.Builder):
                    ...
                    value = output
            return self._set("per_pod", value)

    class BuilderContext(BuilderContextBase["NodeAllocatableOverhead.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = NodeAllocatableOverhead.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for NodeAllocatableOverhead."""
        return cls.BuilderContext()

    @classmethod
    def list_builder(cls) -> GenericListBuilder["NodeAllocatableOverhead", Builder]:
        return GenericListBuilder[NodeAllocatableOverhead, NodeAllocatableOverhead.Builder]()

    per_container: Annotated[Quantity | None, Field(alias="perContainer")] = None
    "PerContainer is applied per container reference to the claim. This models overhead scaling linearly with the number of containers actively using the device. When both PerPod and PerContainer are specified, the total overhead allocated for each pod referencing the claim is computed as: Quantity = PerPod + (PerContainer * NumReferences) Kubelet accounts for this overhead in cgroups: - Pod-level cgroup (requests and limits): Kubelet adds PerPod + (PerContainer * NumReferences). - Container-level cgroup (limits only): Kubelet adds PerPod + PerContainer for each referencing container. This allows any single container to access the pod-level overhead, while the parent cgroup caps the total usage to account for PerPod exactly once."
    per_pod: Annotated[Quantity | None, Field(alias="perPod")] = None
    "PerPod is overhead applied once per pod referencing the claim on this node. This is a flat overhead incurred for every pod referencing the claim."


class NodeAllocatableResource(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> type["NodeAllocatableResource"]:
            return NodeAllocatableResource

        def build(self) -> "NodeAllocatableResource":
            return NodeAllocatableResource(**self._attrs)

        @overload
        def mapping(
            self, value_or_callback: NodeAllocatableMapping | None, /
        ) -> "NodeAllocatableResource.Builder": ...
        ...
        def mapping(
            ...
            value_or_callback: Callable[
                [NodeAllocatableMapping.Builder],
                NodeAllocatableMapping.Builder | NodeAllocatableMapping,
            ],
            /,
        ) -> "NodeAllocatableResource.Builder": ...
        ...
        def mapping(
            self, value_or_callback: Never = ...
        ) -> "NodeAllocatableMapping.BuilderContext": ...

        def mapping(self, value_or_callback=UNSET, /):
            ...
            if self._in_context and value_or_callback is UNSET:
                context = NodeAllocatableMapping.BuilderContext()
                context._parent_builder = self
                context._field_name = "mapping"
                return context
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(NodeAllocatableMapping.builder())
                if isinstance(output, NodeAllocatableMapping.Builder):
                    value = output.build()
                else:
                    value = output
        ...
        @overload
        def overhead(
            self, value_or_callback: NodeAllocatableOverhead | None, /
        ) -> "NodeAllocatableResource.Builder": ...
        ...
        def overhead(
            ...
            value_or_callback: Callable[
                [NodeAllocatableOverhead.Builder],
                NodeAllocatableOverhead.Builder | NodeAllocatableOverhead,
            ],
            /,
        ) -> "NodeAllocatableResource.Builder": ...
        ...
        def overhead(
            self, value_or_callback: Never = ...
        ) -> "NodeAllocatableOverhead.BuilderContext": ...
        ...
        def overhead(self, value_or_callback=UNSET, /):
            ...
            if self._in_context and value_or_callback is UNSET:
                context = NodeAllocatableOverhead.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(NodeAllocatableOverhead.builder())
                if isinstance(output, NodeAllocatableOverhead.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("overhead", value)

    class BuilderContext(BuilderContextBase["NodeAllocatableResource.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = NodeAllocatableResource.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for NodeAllocatableResource."""
        return cls.BuilderContext()

    @classmethod
    def list_builder(cls) -> GenericListBuilder["NodeAllocatableResource", Builder]:
        return GenericListBuilder[NodeAllocatableResource, NodeAllocatableResource.Builder]()
...
class DeviceRequestAllocationResult(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def skip_node_operations(self, value: list[str] | None, /) -> Self:
            ...
            return self._set("skip_node_operations", value)
    ...
    share_id: Annotated[str | None, Field(alias="shareID")] = None
    "ShareID uniquely identifies an individual allocation share of the device, used when the device supports multiple simultaneous allocations. It serves as an additional map key to differentiate concurrent shares of the same device."
    skip_node_operations: Annotated[list[str] | None, Field(alias="skipNodeOperations")] = None
    "SkipNodeOperations lists node-local resource operations (gRPC calls) that will be skipped for this allocated device when determining whether operations are necessary on the node. If all allocated devices for a driver in a claim skip an operation, that gRPC call will be skipped. It is a copy of the ResourceSlice.spec.skipNodeOperations value at the time when the device was allocated."
    tolerations: list[DeviceToleration] | None = None
    "A copy of all tolerations specified in the request at the time when the device got allocated.\n\nThe maximum number of tolerations is 16.\n\nThis is a beta field and requires enabling the DRADeviceTaints feature gate."
...
class Device(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def node_allocatable_resources(
            self, value: dict[str, NodeAllocatableResource] | None, /
        ) -> Self:
            ...
            return self._set("node_allocatable_resources", value)
        ...
        @overload
        def taints(self, value_or_callback: list[DeviceTaint] | None, /) -> "Device.Builder": ...
    ...
    name: str
    "Name is unique identifier among all devices managed by the driver in the pool. It must be a DNS label."
    node_allocatable_resources: Annotated[
        dict[str, NodeAllocatableResource] | None,
        Field(alias="nodeAllocatableResources"),
    ] = None
    'NodeAllocatableResources defines the mapping of node resources that are managed by the DRA driver exposing this device. This includes resources currently reported in v1.Node `status.allocatable` that are not extended resources (see https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/#extended-resources). Examples include "cpu", "memory", "ephemeral-storage", and hugepages. In addition to standard requests made through the Pod `spec`, these resources can also be requested through claims and allocated by the DRA driver. For example, a CPU DRA driver might allocate exclusive CPUs or auxiliary node memory dependencies of an accelerator device. The keys of this map are the node-allocatable resource names (e.g., "cpu", "memory"). Extended resource names are not permitted as keys.'
...
class DeviceClass(Resource):
    ...
    class Builder(BaseModelBuilder):
        ...
        def api_version(self, value: Literal["resource.k8s.io/v1beta2"], /) -> Self:
        ...
        @overload
        def spec(self, value_or_callback: DeviceClassSpec | None, /) -> "DeviceClass.Builder": ...
    ...
    api_version: Annotated[Literal["resource.k8s.io/v1beta2"], Field(alias="apiVersion")] = (
...
class DeviceRequest(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def exactly(
            self, value_or_callback: ExactDeviceRequest | None, /
        ...
        def exactly(
            ...
            value_or_callback: Callable[
                [ExactDeviceRequest.Builder],
                ExactDeviceRequest.Builder | ExactDeviceRequest,
            ],
            /,
        ) -> "DeviceRequest.Builder": ...
        ...
        def exactly(
            self, value_or_callback: Never = ...
        ) -> "ExactDeviceRequest.BuilderContext": ...

        def exactly(self, value_or_callback=UNSET, /):
            "Exactly specifies the details for a single request that must be met exactly for the request to be satisfied.\n\nOne of Exactly or FirstAvailable must be set."
            if self._in_context and value_or_callback is UNSET:
                context = ExactDeviceRequest.BuilderContext()
                context._parent_builder = self
                context._field_name = "exactly"
                return context
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(ExactDeviceRequest.builder())
                if isinstance(output, ExactDeviceRequest.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("exactly", value)
...
class ResourceSliceSpec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def partition_type_attribute(self, value: str | None, /) -> Self:
            ...
            return self._set("partition_type_attribute", value)
    ...
    node_selector: Annotated[v1.NodeSelector | None, Field(alias="nodeSelector")] = None
    "NodeSelector defines which nodes have access to the resources in the pool, when that pool is not limited to a single node.\n\nMust use exactly one term.\n\nExactly one of NodeName, NodeSelector, AllNodes, and PerDeviceNodeSelection must be set."
    partition_type_attribute: Annotated[str | None, Field(alias="partitionTypeAttribute")] = None
    'PartitionTypeAttribute names a string device attribute (by fully qualified name, e.g. "gpu.example.com/profile") whose value labels each device with its partition type, such as "Full" or "Half" for a MIG-style GPU.\n\nWhen set, every partitionable device in the slice must carry the attribute and devices sharing a value must share the same ConsumesCounters cost.'
...
class ResourceClaimTemplateSpec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def spec(
            self, value_or_callback: ResourceClaimSpec | None, /
        ) -> "ResourceClaimTemplateSpec.Builder": ...
...
class ResourceClaimTemplate(Resource):
    ...
    class Builder(BaseModelBuilder):
        ...
        @overload
        def spec(
            self, value_or_callback: ResourceClaimTemplateSpec | None, /
        ) -> "ResourceClaimTemplate.Builder": ...
