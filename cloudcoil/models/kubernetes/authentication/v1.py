...
class TokenRequestSpec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def attestations(self, value: dict[str, list[str]] | None, /) -> Self:
...
class TokenRequestStatus(BaseModel):
    ...
    expiration_timestamp: Annotated[Time | None, Field(alias="expirationTimestamp")] = None
    "expirationTimestamp is the time of expiration of the returned token."
    token: str | None = None
    "token is the opaque bearer token."
...
class TokenRequest(Resource):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def spec(self, value_or_callback: TokenRequestSpec | None, /) -> "TokenRequest.Builder": ...
