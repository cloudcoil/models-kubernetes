...
class AggregationRule(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def cluster_role_selectors(
            self, value_or_callback: List[v1.LabelSelector], /
        ...
        def cluster_role_selectors(
            ...
            value_or_callback: Callable[
                [GenericListBuilder[v1.LabelSelector, v1.LabelSelector.Builder]],
                GenericListBuilder[v1.LabelSelector, v1.LabelSelector.Builder]
                | List[v1.LabelSelector],
            ],
            /,
        ) -> "AggregationRule.Builder": ...
        ...
        ) -> ListBuilderContext[v1.LabelSelector.Builder]: ...
        ...
        def cluster_role_selectors(self, value_or_callback=None, /):
            ...
            if self._in_context and value_or_callback is None:
                context = ListBuilderContext[v1.LabelSelector.Builder]()
            ...
            if callable(value_or_callback):
                output = value_or_callback(v1.LabelSelector.list_builder())
    ...
    cluster_role_selectors: Annotated[
        Optional[List[v1.LabelSelector]], Field(alias="clusterRoleSelectors")
    ] = None
    """
    ClusterRoleSelectors holds a list of selectors which will be used to find ClusterRoles and create the rules. If any of the selectors match, then the ClusterRole's permissions will be added
    """
...
class Role(Resource):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def metadata(self, value_or_callback: Optional[v1.ObjectMeta], /) -> "Role.Builder": ...
