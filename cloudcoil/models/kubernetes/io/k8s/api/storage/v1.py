...
class VolumeError(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def time(self, value_or_callback: Optional[v1.Time], /) -> "VolumeError.Builder": ...
        ...
        @overload
        def time(self, value_or_callback: Never = ...) -> "v1.Time.BuilderContext": ...
...
class CSINode(Resource):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def metadata(self, value_or_callback: Optional[v1.ObjectMeta], /) -> "CSINode.Builder": ...
...
class CSIStorageCapacity(Resource):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def capacity(
            self, value_or_callback: Optional[resource.Quantity], /
        ...
        def capacity(
            ...
            value_or_callback: Callable[
                ...
                resource.Quantity.Builder | resource.Quantity,
            ],
            /,
        ) -> "CSIStorageCapacity.Builder": ...
        ...
        def capacity(
            self, value_or_callback: Never = ...
        ) -> "resource.Quantity.BuilderContext": ...
        ...
        def capacity(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = resource.Quantity.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(resource.Quantity.builder())
                if isinstance(output, resource.Quantity.Builder):
                    value = output.build()
                else:
                    value = output
        ...
        @overload
        def node_topology(
            self, value_or_callback: Optional[v1.LabelSelector], /
        ) -> "CSIStorageCapacity.Builder": ...
        ...
        def node_topology(
            self, value_or_callback: Never = ...
        ) -> "v1.LabelSelector.BuilderContext": ...
    ...
    maximum_volume_size: Annotated[
        Optional[resource.Quantity], Field(alias="maximumVolumeSize")
    ] = None
    """
    maximumVolumeSize is the value reported by the CSI driver in its GetCapacityResponse for a GetCapacityRequest with topology and parameters that match the previous fields.
    ...
    More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
    """
    node_topology: Annotated[Optional[v1.LabelSelector], Field(alias="nodeTopology")] = None
    """
    nodeTopology defines which nodes have access to the storage for which capacity was reported. If not set, the storage is not accessible from any node in the cluster. If empty, the storage is accessible from all nodes. This field is immutable.
    """
...
class StorageClass(Resource):
    class Builder(BaseModelBuilder):
        ...
        def allowed_topologies(
            self, value_or_callback: List[v1_1.TopologySelectorTerm], /
        ...
        def allowed_topologies(
            self,
            value_or_callback: Callable[
                [GenericListBuilder[v1_1.TopologySelectorTerm, v1_1.TopologySelectorTerm.Builder]],
                GenericListBuilder[v1_1.TopologySelectorTerm, v1_1.TopologySelectorTerm.Builder]
                | List[v1_1.TopologySelectorTerm],
            ],
            /,
        ) -> "StorageClass.Builder": ...
        ...
        def allowed_topologies(
            self, value_or_callback: Never = ...
        ) -> ListBuilderContext[v1_1.TopologySelectorTerm.Builder]: ...
        ...
        def allowed_topologies(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = ListBuilderContext[v1_1.TopologySelectorTerm.Builder]()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(v1_1.TopologySelectorTerm.list_builder())
                if isinstance(output, GenericListBuilder):
                    value = output.build()
                else:
                    value = output
    ...
    allowed_topologies: Annotated[
        Optional[List[v1_1.TopologySelectorTerm]], Field(alias="allowedTopologies")
    ] = None
    """
    allowedTopologies restrict the node topologies where volumes can be dynamically provisioned. Each volume plugin defines its own supported topology specifications. An empty TopologySelectorTerm list means there is no topology restriction. This field is only honored by servers that enable the VolumeScheduling feature.
    """
...
class VolumeAttachmentSource(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def inline_volume_spec(
            self, value_or_callback: Optional[v1_1.PersistentVolumeSpec], /
        ...
        def inline_volume_spec(
            self,
            value_or_callback: Callable[
                [v1_1.PersistentVolumeSpec.Builder],
                v1_1.PersistentVolumeSpec.Builder | v1_1.PersistentVolumeSpec,
            ],
            /,
        ) -> "VolumeAttachmentSource.Builder": ...
        ...
        def inline_volume_spec(
            self, value_or_callback: Never = ...
        ) -> "v1_1.PersistentVolumeSpec.BuilderContext": ...
        ...
        def inline_volume_spec(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = v1_1.PersistentVolumeSpec.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(v1_1.PersistentVolumeSpec.builder())
                if isinstance(output, v1_1.PersistentVolumeSpec.Builder):
                    value = output.build()
                else:
                    value = output
    ...
    inline_volume_spec: Annotated[
        Optional[v1_1.PersistentVolumeSpec], Field(alias="inlineVolumeSpec")
    ] = None
    """
    inlineVolumeSpec contains all the information necessary to attach a persistent volume defined by a pod's inline VolumeSource. This field is populated only for the CSIMigration feature. It contains translated fields from a pod's inline VolumeSource to a PersistentVolumeSpec. This field is beta-level and is only honored by servers that enabled the CSIMigration feature.
    """
