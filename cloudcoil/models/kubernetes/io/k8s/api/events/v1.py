...
class EventSeries(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def last_observed_time(
            self, value_or_callback: v1.MicroTime, /
        ) -> "EventSeries.Builder": ...
        ...
        def last_observed_time(
            ...
            value_or_callback: Callable[
                [v1.MicroTime.Builder], v1.MicroTime.Builder | v1.MicroTime
            ],
            /,
        ) -> "EventSeries.Builder": ...
        ...
        def last_observed_time(self, value_or_callback=None, /):
            ...
            if self._in_context and value_or_callback is None:
                context = v1.MicroTime.BuilderContext()
            ...
            if callable(value_or_callback):
                output = value_or_callback(v1.MicroTime.builder())
                if isinstance(output, v1.MicroTime.Builder):
                    value = output.build()
                else:
                    value = output
    ...
    count is the number of occurrences in this series up to the last heartbeat time.
    """
    last_observed_time: Annotated[v1.MicroTime, Field(alias="lastObservedTime")]
    """
    lastObservedTime is the time when last Event from the series was seen before last heartbeat.
    """
...
class Event(Resource):
    class Builder(BaseModelBuilder):
        ...
        def deprecated_source(
            self, value_or_callback: Optional[v1_1.EventSource], /
        ) -> "Event.Builder": ...
        ...
        def deprecated_source(
            self,
            value_or_callback: Callable[
                [v1_1.EventSource.Builder], v1_1.EventSource.Builder | v1_1.EventSource
            ],
            /,
        ) -> "Event.Builder": ...
        ...
        def deprecated_source(
            self, value_or_callback: Never = ...
        ) -> "v1_1.EventSource.BuilderContext": ...
        ...
        def deprecated_source(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = v1_1.EventSource.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(v1_1.EventSource.builder())
                if isinstance(output, v1_1.EventSource.Builder):
                    value = output.build()
                else:
                    value = output
        ...
        @overload
        def event_time(self, value_or_callback: v1.MicroTime, /) -> "Event.Builder": ...
        ...
        @overload
        def event_time(self, value_or_callback: Never = ...) -> "v1.MicroTime.BuilderContext": ...
        ...
        @overload
        def metadata(self, value_or_callback: Optional[v1.ObjectMeta], /) -> "Event.Builder": ...
        ...
        @overload
        def regarding(
            self, value_or_callback: Optional[v1_1.ObjectReference], /
        ) -> "Event.Builder": ...
        ...
        def regarding(
            self, value_or_callback: Never = ...
        ) -> "v1_1.ObjectReference.BuilderContext": ...
    ...
    deprecated_first_timestamp: Annotated[
        Optional[v1.Time], Field(alias="deprecatedFirstTimestamp")
    ] = None
    """
    deprecatedFirstTimestamp is the deprecated field assuring backward compatibility with core.v1 Event type.
    """
    deprecated_last_timestamp: Annotated[
        Optional[v1.Time], Field(alias="deprecatedLastTimestamp")
    ] = None
    """
    deprecatedLastTimestamp is the deprecated field assuring backward compatibility with core.v1 Event type.
    """
    deprecated_source: Annotated[Optional[v1_1.EventSource], Field(alias="deprecatedSource")] = None
    """
    deprecatedSource is the deprecated field assuring backward compatibility with core.v1 Event type.
    """
    event_time: Annotated[v1.MicroTime, Field(alias="eventTime")]
    """
    eventTime is the time when this Event was first observed. It is required.
    """
    ...
    reason is why the action was taken. It is human-readable. This field cannot be empty for new Events and it can have at most 128 characters.
    """
    regarding: Optional[v1_1.ObjectReference] = None
    """
    regarding contains the object this Event is about. In most cases it's an Object reporting controller implements, e.g. ReplicaSetController implements ReplicaSets and this event is emitted because it acts on some changes in a ReplicaSet object.
    """
    related: Optional[v1_1.ObjectReference] = None
    """
    related is the optional secondary object for more complex actions. E.g. when regarding object triggers a creation or deletion of related object.
    """
