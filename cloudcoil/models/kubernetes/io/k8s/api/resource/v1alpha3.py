...
class BasicDevice(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def capacity(self, value: Optional[Dict[str, resource.Quantity]], /) -> Self:
            """
    ...
    The maximum number of attributes and capacities combined is 32.
    """
    capacity: Optional[Dict[str, resource.Quantity]] = None
    """
    Capacity defines the set of capacities for this device. The name of each capacity must be unique in that set.
...
class AllocatedDeviceStatus(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def conditions(
            self, value_or_callback: List[v1_1.Condition], /
        ...
        def conditions(
            self,
            value_or_callback: Callable[
                [GenericListBuilder[v1_1.Condition, v1_1.Condition.Builder]],
                GenericListBuilder[v1_1.Condition, v1_1.Condition.Builder] | List[v1_1.Condition],
            ],
            /,
        ) -> "AllocatedDeviceStatus.Builder": ...
        ...
        def conditions(
            self, value_or_callback: Never = ...
        ) -> ListBuilderContext[v1_1.Condition.Builder]: ...
        ...
        def conditions(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = ListBuilderContext[v1_1.Condition.Builder]()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(v1_1.Condition.list_builder())
                if isinstance(output, GenericListBuilder):
                    value = output.build()
                else:
                    value = output
    ...
    conditions: Optional[List[v1_1.Condition]] = None
    """
    Conditions contains the latest observation of the device's state. If the device has been configured according to the class and claim config references, the `Ready` condition should be True.
    """
