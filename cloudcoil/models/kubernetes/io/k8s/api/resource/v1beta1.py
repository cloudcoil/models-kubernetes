...
class DeviceCapacity(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def value(self, value_or_callback: resource.Quantity, /) -> "DeviceCapacity.Builder": ...
        ...
        @overload
        def value(self, value_or_callback: Never = ...) -> "resource.Quantity.BuilderContext": ...
    ...
    class ListBuilder(GenericListBuilder["DeviceCapacity", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use DeviceCapacity.list_builder() instead."
            )
...
class OpaqueDeviceConfiguration(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def parameters(
            self, value_or_callback: runtime.RawExtension, /
        ...
        def parameters(
            self, value_or_callback: Never = ...
        ) -> "runtime.RawExtension.BuilderContext": ...
...
class AllocatedDeviceStatus(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def conditions(
            self, value_or_callback: List[v1.Condition], /
        ...
        def conditions(
            self,
            value_or_callback: Callable[
                [GenericListBuilder[v1.Condition, v1.Condition.Builder]],
                GenericListBuilder[v1.Condition, v1.Condition.Builder] | List[v1.Condition],
            ],
            /,
        ) -> "AllocatedDeviceStatus.Builder": ...
        ...
        def conditions(
            self, value_or_callback: Never = ...
        ) -> ListBuilderContext[v1.Condition.Builder]: ...
        ...
        def conditions(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = ListBuilderContext[v1.Condition.Builder]()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(v1.Condition.list_builder())
                if isinstance(output, GenericListBuilder):
                    value = output.build()
                else:
                    value = output
...
class BasicDevice(BaseModel):
    ...
    The maximum number of attributes and capacities combined is 32.
    """
    capacity: Optional[Dict[str, DeviceCapacity]] = None
    """
    Capacity defines the set of capacities for this device. The name of each capacity must be unique in that set.
...
class ResourceSliceSpec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def node_selector(
            self, value_or_callback: Optional[v1_1.NodeSelector], /
        ) -> "ResourceSliceSpec.Builder": ...
        ...
        def node_selector(
            self,
            value_or_callback: Callable[
                [v1_1.NodeSelector.Builder],
                v1_1.NodeSelector.Builder | v1_1.NodeSelector,
            ],
            /,
        ) -> "ResourceSliceSpec.Builder": ...
        ...
        def node_selector(
            self, value_or_callback: Never = ...
        ) -> "v1_1.NodeSelector.BuilderContext": ...
        ...
        def node_selector(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = v1_1.NodeSelector.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(v1_1.NodeSelector.builder())
                if isinstance(output, v1_1.NodeSelector.Builder):
                    value = output.build()
                else:
                    value = output
    ...
    Exactly one of NodeName, NodeSelector and AllNodes must be set. This field is immutable.
    """
    node_selector: Annotated[Optional[v1_1.NodeSelector], Field(alias="nodeSelector")] = None
    """
    NodeSelector defines which nodes have access to the resources in the pool, when that pool is not limited to a single node.
...
class DeviceClass(Resource):
    ...
    api_version: Annotated[
        Optional[Literal["resource.k8s.io/v1beta1"]], Field(alias="apiVersion")
