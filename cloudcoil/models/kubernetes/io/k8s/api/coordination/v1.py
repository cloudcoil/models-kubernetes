...
class LeaseSpec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def acquire_time(
            self, value_or_callback: Optional[v1.MicroTime], /
        ) -> "LeaseSpec.Builder": ...
        ...
        @overload
        def acquire_time(self, value_or_callback: Never = ...) -> "v1.MicroTime.BuilderContext": ...
        ...
        @overload
        def renew_time(self, value_or_callback: Never = ...) -> "v1.MicroTime.BuilderContext": ...
    ...
    acquire_time: Annotated[Optional[v1.MicroTime], Field(alias="acquireTime")] = None
    """
    acquireTime is a time when the current lease was acquired.
    """
    ...
    PreferredHolder signals to a lease holder that the lease has a more optimal holder and should be given up. This field can only be set if Strategy is also set.
    """
    renew_time: Annotated[Optional[v1.MicroTime], Field(alias="renewTime")] = None
    """
    renewTime is a time when the current holder of a lease has last updated the lease.
    """
...
class Lease(Resource):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def metadata(self, value_or_callback: Optional[v1.ObjectMeta], /) -> "Lease.Builder": ...
