...
class CronJobStatus(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def last_schedule_time(
            self, value_or_callback: Optional[v1_1.Time], /
        ) -> "CronJobStatus.Builder": ...

        @overload
        def last_schedule_time(
            self,
            value_or_callback: Callable[[v1_1.Time.Builder], v1_1.Time.Builder | v1_1.Time],
            /,
        ) -> "CronJobStatus.Builder": ...
        ...
        def last_schedule_time(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = v1_1.Time.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(v1_1.Time.builder())
                if isinstance(output, v1_1.Time.Builder):
                    value = output.build()
                else:
                    value = output
    ...
    A list of pointers to currently running jobs.
    """
    last_schedule_time: Annotated[Optional[v1_1.Time], Field(alias="lastScheduleTime")] = None
    """
    Information when was the last time the job was successfully scheduled.
    """
    last_successful_time: Annotated[Optional[v1_1.Time], Field(alias="lastSuccessfulTime")] = None
    """
    Information when was the last time the job successfully completed.
    """
...
class JobCondition(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def last_probe_time(self, value_or_callback: Never = ...) -> "v1_1.Time.BuilderContext": ...
    ...
    last_probe_time: Annotated[Optional[v1_1.Time], Field(alias="lastProbeTime")] = None
    """
    Last time the condition was checked.
    """
    last_transition_time: Annotated[Optional[v1_1.Time], Field(alias="lastTransitionTime")] = None
    """
    Last time the condition transit from one status to another.
    """
...
class JobStatus(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def completion_time(self, value_or_callback: Never = ...) -> "v1_1.Time.BuilderContext": ...
        ...
        @overload
        def start_time(self, value_or_callback: Optional[v1_1.Time], /) -> "JobStatus.Builder": ...
        ...
        @overload
        def start_time(self, value_or_callback: Never = ...) -> "v1_1.Time.BuilderContext": ...
    ...
    completedIndexes holds the completed indexes when .spec.completionMode = "Indexed" in a text format. The indexes are represented as decimal integers separated by commas. The numbers are listed in increasing order. Three or more consecutive numbers are compressed and represented by the first and last element of the series, separated by a hyphen. For example, if the completed indexes are 1, 3, 4, 5 and 7, they are represented as "1,3-5,7".
    """
    completion_time: Annotated[Optional[v1_1.Time], Field(alias="completionTime")] = None
    """
    Represents time when the job was completed. It is not guaranteed to be set in happens-before order across separate operations. It is represented in RFC3339 form and is in UTC. The completion time is set when the job finishes successfully, and only then. The value cannot be updated or removed. The value indicates the same or later point in time as the startTime field.
    """
    ...
    The number of pods which have a Ready condition.
    """
    start_time: Annotated[Optional[v1_1.Time], Field(alias="startTime")] = None
    """
    Represents time when the job controller started processing a job. When a Job is created in the suspended state, this field is not set until the first time it is resumed. This field is reset every time a Job is resumed from suspension. It is represented in RFC3339 form and is in UTC.
...
class JobSpec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def selector(
            self, value_or_callback: Optional[v1_1.LabelSelector], /
        ) -> "JobSpec.Builder": ...
        ...
        def selector(
            self,
            value_or_callback: Callable[
                [v1_1.LabelSelector.Builder],
                v1_1.LabelSelector.Builder | v1_1.LabelSelector,
            ],
            /,
        ) -> "JobSpec.Builder": ...
        ...
        def selector(
            self, value_or_callback: Never = ...
        ) -> "v1_1.LabelSelector.BuilderContext": ...
        ...
        def selector(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = v1_1.LabelSelector.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(v1_1.LabelSelector.builder())
                if isinstance(output, v1_1.LabelSelector.Builder):
                    value = output.build()
                else:
                    value = output
...
class JobTemplateSpec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def metadata(
            self, value_or_callback: Optional[v1_1.ObjectMeta], /
        ...
        def metadata(
            self,
            value_or_callback: Callable[
                [v1_1.ObjectMeta.Builder], v1_1.ObjectMeta.Builder | v1_1.ObjectMeta
            ],
            /,
        ) -> "JobTemplateSpec.Builder": ...

        @overload
        def metadata(self, value_or_callback: Never = ...) -> "v1_1.ObjectMeta.BuilderContext": ...
        ...
        def metadata(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = v1_1.ObjectMeta.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(v1_1.ObjectMeta.builder())
                if isinstance(output, v1_1.ObjectMeta.Builder):
                    value = output.build()
                else:
                    value = output
...
class Job(Resource):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def metadata(self, value_or_callback: Optional[v1_1.ObjectMeta], /) -> "Job.Builder": ...
