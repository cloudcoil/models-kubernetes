...
class DaemonSetCondition(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def last_transition_time(
            self, value_or_callback: Optional[v1.Time], /
        ) -> "DaemonSetCondition.Builder": ...

        @overload
        def last_transition_time(
            self,
            value_or_callback: Callable[[v1.Time.Builder], v1.Time.Builder | v1.Time],
            /,
        ) -> "DaemonSetCondition.Builder": ...
        ...
        def last_transition_time(self, value_or_callback=None, /):
            ...
            if self._in_context and value_or_callback is None:
                context = v1.Time.BuilderContext()
            ...
            if callable(value_or_callback):
                output = value_or_callback(v1.Time.builder())
                if isinstance(output, v1.Time.Builder):
                    value = output.build()
                else:
                    value = output
...
class DeploymentCondition(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def last_update_time(self, value_or_callback: Never = ...) -> "v1.Time.BuilderContext": ...
    ...
    Last time the condition transitioned from one status to another.
    """
    last_update_time: Annotated[Optional[v1.Time], Field(alias="lastUpdateTime")] = None
    """
    The last time this condition was updated.
    """
    message: Optional[str] = None
...
class RollingUpdateDaemonSet(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def max_surge(
            self, value_or_callback: Optional[intstr.IntOrString], /
        ...
        def max_surge(
            ...
            value_or_callback: Callable[
                ...
                intstr.IntOrString.Builder | intstr.IntOrString,
            ],
            /,
        ) -> "RollingUpdateDaemonSet.Builder": ...
        ...
        def max_surge(
            self, value_or_callback: Never = ...
        ) -> "intstr.IntOrString.BuilderContext": ...
        ...
        def max_surge(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = intstr.IntOrString.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(intstr.IntOrString.builder())
                if isinstance(output, intstr.IntOrString.Builder):
                    value = output.build()
                else:
                    value = output
    ...
    max_surge: Annotated[Optional[intstr.IntOrString], Field(alias="maxSurge")] = None
    """
    The maximum number of nodes with an existing available DaemonSet pod that can have an updated DaemonSet pod during during an update. Value can be an absolute number (ex: 5) or a percentage of desired pods (ex: 10%). This can not be 0 if MaxUnavailable is 0. Absolute number is calculated from percentage by rounding up to a minimum of 1. Default value is 0. Example: when this is set to 30%, at most 30% of the total number of nodes that should be running the daemon pod (i.e. status.desiredNumberScheduled) can have their a new pod created before the old pod is marked as deleted. The update starts by launching new pods on 30% of nodes. Once an updated pod is available (Ready for at least minReadySeconds) the old DaemonSet pod on that node is marked deleted. If the old pod becomes unavailable for any reason (Ready transitions to false, is evicted, or is drained) an updated pod is immediatedly created on that node without considering surge limits. Allowing surge implies the possibility that the resources consumed by the daemonset on any given node can double if the readiness check fails, and so resource intensive daemonsets should take into account that they may cause evictions during disruption.
    """
    max_unavailable: Annotated[Optional[intstr.IntOrString], Field(alias="maxUnavailable")] = None
    """
    The maximum number of DaemonSet pods that can be unavailable during the update. Value can be an absolute number (ex: 5) or a percentage of total number of DaemonSet pods at the start of the update (ex: 10%). Absolute number is calculated from percentage by rounding up. This cannot be 0 if MaxSurge is 0 Default value is 1. Example: when this is set to 30%, at most 30% of the total number of nodes that should be running the daemon pod (i.e. status.desiredNumberScheduled) can have their pods stopped for an update at any given time. The update starts by stopping at most 30% of those DaemonSet pods and then brings up new DaemonSet pods in their place. Once the new pods are available, it then proceeds onto other DaemonSet pods, thus ensuring that at least 70% of original number of DaemonSet pods are available at all times during the update.
    """
...
class ControllerRevision(Resource):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def data(
            self, value_or_callback: Optional[runtime.RawExtension], /
        ...
        def data(
            ...
            value_or_callback: Callable[
                ...
                runtime.RawExtension.Builder | runtime.RawExtension,
            ],
            /,
        ) -> "ControllerRevision.Builder": ...

        @overload
        def data(self, value_or_callback: Never = ...) -> "runtime.RawExtension.BuilderContext": ...
        ...
        def data(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = runtime.RawExtension.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(runtime.RawExtension.builder())
                if isinstance(output, runtime.RawExtension.Builder):
                    value = output.build()
                else:
                    value = output
...
class DaemonSetSpec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def selector(self, value_or_callback: v1.LabelSelector, /) -> "DaemonSetSpec.Builder": ...

        @overload
        def selector(
            self,
            value_or_callback: Callable[
                [v1.LabelSelector.Builder], v1.LabelSelector.Builder | v1.LabelSelector
            ],
            /,
        ) -> "DaemonSetSpec.Builder": ...

        @overload
        def selector(self, value_or_callback: Never = ...) -> "v1.LabelSelector.BuilderContext": ...
        ...
        def selector(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = v1.LabelSelector.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(v1.LabelSelector.builder())
                if isinstance(output, v1.LabelSelector.Builder):
                    value = output.build()
                else:
                    value = output
        ...
        @overload
        def template(
            self, value_or_callback: v1_1.PodTemplateSpec, /
        ) -> "DaemonSetSpec.Builder": ...
        ...
        def template(
            self,
            value_or_callback: Callable[
                [v1_1.PodTemplateSpec.Builder],
                v1_1.PodTemplateSpec.Builder | v1_1.PodTemplateSpec,
            ],
            /,
        ) -> "DaemonSetSpec.Builder": ...
        ...
        def template(
            self, value_or_callback: Never = ...
        ) -> "v1_1.PodTemplateSpec.BuilderContext": ...
        ...
        def template(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = v1_1.PodTemplateSpec.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(v1_1.PodTemplateSpec.builder())
                if isinstance(output, v1_1.PodTemplateSpec.Builder):
                    value = output.build()
                else:
                    value = output
...
class DeploymentSpec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def selector(self, value_or_callback: v1.LabelSelector, /) -> "DeploymentSpec.Builder": ...
...
class ReplicaSetSpec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def selector(self, value_or_callback: v1.LabelSelector, /) -> "ReplicaSetSpec.Builder": ...
        ...
        @overload
        def template(
            self, value_or_callback: Optional[v1_1.PodTemplateSpec], /
        ) -> "ReplicaSetSpec.Builder": ...
    ...
    Selector is a label query over pods that should match the replica count. Label keys and values that must match in order to be controlled by this replica set. It must match the pod template's labels. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors
    """
    template: Optional[v1_1.PodTemplateSpec] = None
    """
    Template is the object that describes the pod that will be created if insufficient replicas are detected. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller#pod-template
    """
...
class StatefulSetSpec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def selector(self, value_or_callback: v1.LabelSelector, /) -> "StatefulSetSpec.Builder": ...
        ...
        def volume_claim_templates(
            self, value_or_callback: List[v1_1.PersistentVolumeClaim], /
        ) -> "StatefulSetSpec.Builder": ...
        ...
        def volume_claim_templates(
            ...
            value_or_callback: Callable[
                [
                    GenericListBuilder[
                        v1_1.PersistentVolumeClaim, v1_1.PersistentVolumeClaim.Builder
                    ]
                ],
                GenericListBuilder[v1_1.PersistentVolumeClaim, v1_1.PersistentVolumeClaim.Builder]
                | List[v1_1.PersistentVolumeClaim],
            ],
            /,
        ) -> "StatefulSetSpec.Builder": ...
        ...
        def volume_claim_templates(
            self, value_or_callback: Never = ...
        ) -> ListBuilderContext[v1_1.PersistentVolumeClaim.Builder]: ...
        ...
        def volume_claim_templates(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = ListBuilderContext[v1_1.PersistentVolumeClaim.Builder]()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(v1_1.PersistentVolumeClaim.list_builder())
                if isinstance(output, GenericListBuilder):
                    value = output.build()
                else:
                    value = output
    ...
    volume_claim_templates: Annotated[
        Optional[List[v1_1.PersistentVolumeClaim]], Field(alias="volumeClaimTemplates")
    ] = None
    """
    volumeClaimTemplates is a list of claims that pods are allowed to reference. The StatefulSet controller is responsible for mapping network identities to claims in a way that maintains the identity of a pod. Every claim in this list must have at least one matching (by name) volumeMount in one container in the template. A claim in this list takes precedence over any volumes in the template, with the same name.
    """
