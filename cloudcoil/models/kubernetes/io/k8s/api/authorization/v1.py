...
class FieldSelectorAttributes(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def requirements(
            self, value_or_callback: List[v1.FieldSelectorRequirement], /
        ...
        def requirements(
            ...
            value_or_callback: Callable[
                [
                    GenericListBuilder[
                        v1.FieldSelectorRequirement, v1.FieldSelectorRequirement.Builder
                    ]
                ],
                GenericListBuilder[v1.FieldSelectorRequirement, v1.FieldSelectorRequirement.Builder]
                | List[v1.FieldSelectorRequirement],
            ],
            /,
        ) -> "FieldSelectorAttributes.Builder": ...
        ...
        def requirements(
            self, value_or_callback: Never = ...
        ) -> ListBuilderContext[v1.FieldSelectorRequirement.Builder]: ...
        ...
        def requirements(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = ListBuilderContext[v1.FieldSelectorRequirement.Builder]()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(v1.FieldSelectorRequirement.list_builder())
                if isinstance(output, GenericListBuilder):
                    value = output.build()
                else:
                    value = output
    ...
    rawSelector is the serialization of a field selector that would be included in a query parameter. Webhook implementations are encouraged to ignore rawSelector. The kube-apiserver's *SubjectAccessReview will parse the rawSelector as long as the requirements are not present.
    """
    requirements: Optional[List[v1.FieldSelectorRequirement]] = None
    """
    requirements is the parsed interpretation of a field selector. All requirements must be met for a resource instance to match the selector. Webhook implementations should handle requirements, but how to handle them is up to the webhook. Since requirements can only limit the request, it is safe to authorize as unlimited request if the requirements are not understood.
    """
...
class LabelSelectorAttributes(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def requirements(
            self, value_or_callback: List[v1.LabelSelectorRequirement], /
        ...
        def requirements(
            ...
            value_or_callback: Callable[
                [
                    GenericListBuilder[
                        v1.LabelSelectorRequirement, v1.LabelSelectorRequirement.Builder
                    ]
                ],
                GenericListBuilder[v1.LabelSelectorRequirement, v1.LabelSelectorRequirement.Builder]
                | List[v1.LabelSelectorRequirement],
            ],
            /,
        ) -> "LabelSelectorAttributes.Builder": ...
        ...
        def requirements(
            self, value_or_callback: Never = ...
        ) -> ListBuilderContext[v1.LabelSelectorRequirement.Builder]: ...
        ...
        def requirements(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = ListBuilderContext[v1.LabelSelectorRequirement.Builder]()
                context._parent_builder = self
                context._field_name = "requirements"
                return context
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(v1.LabelSelectorRequirement.list_builder())
                if isinstance(output, GenericListBuilder):
                    value = output.build()
                else:
                    value = output
    ...
    rawSelector is the serialization of a field selector that would be included in a query parameter. Webhook implementations are encouraged to ignore rawSelector. The kube-apiserver's *SubjectAccessReview will parse the rawSelector as long as the requirements are not present.
    """
    requirements: Optional[List[v1.LabelSelectorRequirement]] = None
    """
    requirements is the parsed interpretation of a label selector. All requirements must be met for a resource instance to match the selector. Webhook implementations should handle requirements, but how to handle them is up to the webhook. Since requirements can only limit the request, it is safe to authorize as unlimited request if the requirements are not understood.
    """
