...
class APIServiceList(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["APIServiceList"]:
            return APIServiceList

        def build(self) -> "APIServiceList":
            return APIServiceList(**self._attrs)
        ...
        @overload
        def items(self, value_or_callback: List[APIService], /) -> "APIServiceList.Builder": ...

        @overload
        def items(
            self,
            value_or_callback: Callable[
                [GenericListBuilder[APIService, APIService.Builder]],
                GenericListBuilder[APIService, APIService.Builder] | List[APIService],
            ],
            /,
        ) -> "APIServiceList.Builder": ...

        @overload
        def items(
            self, value_or_callback: Never = ...
        ) -> ListBuilderContext[APIService.Builder]: ...
        ...
        def items(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = ListBuilderContext[APIService.Builder]()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(APIService.list_builder())
                if isinstance(output, GenericListBuilder):
                    value = output.build()
                else:
                    value = output
        ...
        def kind(self, value: Optional[Literal["APIServiceList"]], /) -> Self:
            """
            Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
            """
            return self._set("kind", value)
    ...
    class BuilderContext(BuilderContextBase["APIServiceList.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = APIServiceList.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for APIServiceList."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["APIServiceList", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use APIServiceList.list_builder() instead."
            )
    ...
    Items is the list of APIService
    """
    kind: Optional[Literal["APIServiceList"]] = "APIServiceList"
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    """
