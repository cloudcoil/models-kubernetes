...
from ..core import v1
from ..scheduling import v1alpha3
...
class JobSchedulingConfiguration(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> type["JobSchedulingConfiguration"]:
            return JobSchedulingConfiguration

        def build(self) -> "JobSchedulingConfiguration":
            return JobSchedulingConfiguration(**self._attrs)

        @overload
        def disruption_mode(
            self, value_or_callback: v1alpha3.WorkloadPodGroupDisruptionMode | None, /
        ) -> "JobSchedulingConfiguration.Builder": ...

        @overload
        def disruption_mode(
            self,
            value_or_callback: Callable[
                [v1alpha3.WorkloadPodGroupDisruptionMode.Builder],
                v1alpha3.WorkloadPodGroupDisruptionMode.Builder
                | v1alpha3.WorkloadPodGroupDisruptionMode,
            ],
            /,
        ) -> "JobSchedulingConfiguration.Builder": ...
        ...
        def disruption_mode(
            self, value_or_callback: Never = ...
        ) -> "v1alpha3.WorkloadPodGroupDisruptionMode.BuilderContext": ...
        ...
        def disruption_mode(self, value_or_callback=UNSET, /):
            ...
            if self._in_context and value_or_callback is UNSET:
                context = v1alpha3.WorkloadPodGroupDisruptionMode.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(v1alpha3.WorkloadPodGroupDisruptionMode.builder())
                if isinstance(output, v1alpha3.WorkloadPodGroupDisruptionMode.Builder):
                    value = output.build()
                else:
                    value = output
        ...
        def resource_claims(
            self,
            value_or_callback: list[v1alpha3.WorkloadPodGroupResourceClaim] | None,
            /,
        ) -> "JobSchedulingConfiguration.Builder": ...
        ...
        def resource_claims(
            ...
            value_or_callback: Callable[
                [
                    GenericListBuilder[
                        v1alpha3.WorkloadPodGroupResourceClaim,
                        v1alpha3.WorkloadPodGroupResourceClaim.Builder,
                    ]
                ],
                GenericListBuilder[
                    v1alpha3.WorkloadPodGroupResourceClaim,
                ...
                | list[v1alpha3.WorkloadPodGroupResourceClaim],
            ],
            /,
        ) -> "JobSchedulingConfiguration.Builder": ...
        ...
        def resource_claims(
            self, value_or_callback: Never = ...
        ) -> ListBuilderContext[v1alpha3.WorkloadPodGroupResourceClaim.Builder]: ...
        ...
        def resource_claims(self, value_or_callback=UNSET, /):
            ...
            if self._in_context and value_or_callback is UNSET:
                context = ListBuilderContext[v1alpha3.WorkloadPodGroupResourceClaim.Builder]()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(v1alpha3.WorkloadPodGroupResourceClaim.list_builder())
                if isinstance(output, GenericListBuilder):
                    value = output.build()
                else:
                    value = output
        ...
        def scheduling_constraints(
            self,
            value_or_callback: v1alpha3.WorkloadPodGroupSchedulingConstraints | None,
            /,
        ) -> "JobSchedulingConfiguration.Builder": ...
        ...
        def scheduling_constraints(
            self,
            value_or_callback: Callable[
                [v1alpha3.WorkloadPodGroupSchedulingConstraints.Builder],
                v1alpha3.WorkloadPodGroupSchedulingConstraints.Builder
        ...
        def scheduling_constraints(
            self, value_or_callback: Never = ...
        ) -> "v1alpha3.WorkloadPodGroupSchedulingConstraints.BuilderContext": ...
        ...
        def scheduling_constraints(self, value_or_callback=UNSET, /):
            ...
            if self._in_context and value_or_callback is UNSET:
                context = v1alpha3.WorkloadPodGroupSchedulingConstraints.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(v1alpha3.WorkloadPodGroupSchedulingConstraints.builder())
                if isinstance(output, v1alpha3.WorkloadPodGroupSchedulingConstraints.Builder):
                    value = output.build()
                else:
                    value = output
        ...
        def scheduling_policy(
            self, value_or_callback: v1alpha3.WorkloadPodGroupSchedulingPolicy | None, /
        ) -> "JobSchedulingConfiguration.Builder": ...
        ...
        def scheduling_policy(
            self,
            value_or_callback: Callable[
                [v1alpha3.WorkloadPodGroupSchedulingPolicy.Builder],
                v1alpha3.WorkloadPodGroupSchedulingPolicy.Builder
                | v1alpha3.WorkloadPodGroupSchedulingPolicy,
            ],
            /,
        ) -> "JobSchedulingConfiguration.Builder": ...
        ...
        def scheduling_policy(
            self, value_or_callback: Never = ...
        ) -> "v1alpha3.WorkloadPodGroupSchedulingPolicy.BuilderContext": ...
        ...
        def scheduling_policy(self, value_or_callback=UNSET, /):
            ...
            if self._in_context and value_or_callback is UNSET:
                context = v1alpha3.WorkloadPodGroupSchedulingPolicy.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(v1alpha3.WorkloadPodGroupSchedulingPolicy.builder())
                if isinstance(output, v1alpha3.WorkloadPodGroupSchedulingPolicy.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("scheduling_policy", value)

    class BuilderContext(BuilderContextBase["JobSchedulingConfiguration.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = JobSchedulingConfiguration.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for JobSchedulingConfiguration."""
        return cls.BuilderContext()

    @classmethod
    def list_builder(cls) -> GenericListBuilder["JobSchedulingConfiguration", Builder]:
        return GenericListBuilder[JobSchedulingConfiguration, JobSchedulingConfiguration.Builder]()

    disruption_mode: Annotated[
        v1alpha3.WorkloadPodGroupDisruptionMode | None, Field(alias="disruptionMode")
    ] = None
    "DisruptionMode defines the mode in which the Job\u0027s pods can be disrupted. One of Single, All. This field is immutable after creation: it may not be added or removed, and the selected mode may not be changed."
    resource_claims: Annotated[
        list[v1alpha3.WorkloadPodGroupResourceClaim] | None,
        Field(alias="resourceClaims"),
    ] = None
    "ResourceClaims defines which ResourceClaims may be shared among Pods in the Job. Pods consume the devices allocated to a PodGroup\u0027s claim by defining a claim in its own Spec.ResourceClaims that matches the PodGroup\u0027s claim exactly. The claim must have the same name and refer to the same ResourceClaim or ResourceClaimTemplate. At most 4 claims may be set, matching the limit on the resulting PodGroup. This list is immutable after creation: entries may neither be added, removed, nor modified."
    scheduling_constraints: Annotated[
        v1alpha3.WorkloadPodGroupSchedulingConstraints | None,
        Field(alias="schedulingConstraints"),
    ] = None
    "SchedulingConstraints defines scheduling constraints (e.g. topology) for the Job\u0027s pods. This field is immutable after creation."
    scheduling_policy: Annotated[
        v1alpha3.WorkloadPodGroupSchedulingPolicy | None,
        Field(alias="schedulingPolicy"),
    ] = None
    "SchedulingPolicy defines the scheduling policy for this Job. Exactly one of Basic or Gang must be set. This field is immutable after creation: the policy may not be added or removed. The policy variant (basic/gang) is frozen by hand-written validation; only schedulingPolicy.gang.minCount may be changed."
...
class JobSpec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def scheduling(
            self, value_or_callback: JobSchedulingConfiguration | None, /
        ) -> "JobSpec.Builder": ...
        ...
        def scheduling(
            ...
            value_or_callback: Callable[
                [JobSchedulingConfiguration.Builder],
                JobSchedulingConfiguration.Builder | JobSchedulingConfiguration,
            ],
            /,
        ) -> "JobSpec.Builder": ...
        ...
        def scheduling(
            self, value_or_callback: Never = ...
        ) -> "JobSchedulingConfiguration.BuilderContext": ...
        ...
        def scheduling(self, value_or_callback=UNSET, /):
            ...
            if self._in_context and value_or_callback is UNSET:
                context = JobSchedulingConfiguration.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(JobSchedulingConfiguration.builder())
                if isinstance(output, JobSchedulingConfiguration.Builder):
                    value = output.build()
                else:
                    value = output
...
class CronJob(Resource):
    ...
    class Builder(BaseModelBuilder):
        ...
        @overload
        def spec(self, value_or_callback: CronJobSpec, /) -> "CronJob.Builder": ...
