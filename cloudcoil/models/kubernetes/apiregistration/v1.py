...
class APIServiceCondition(BaseModel):
    ...
    @classmethod
    def list_builder(cls) -> GenericListBuilder["APIServiceCondition", Builder]:
        return GenericListBuilder[APIServiceCondition, APIServiceCondition.Builder]()
...
class APIServiceStatus(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def conditions(
            self, value_or_callback: list[APIServiceCondition] | None, /
    ...
    @classmethod
    def list_builder(cls) -> GenericListBuilder["APIServiceStatus", Builder]:
        return GenericListBuilder[APIServiceStatus, APIServiceStatus.Builder]()

    conditions: list[APIServiceCondition] | None = None
    "Current service state of apiService."
...
class APIServiceSpec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def insecure_skip_tls_verify(self, value: bool | None, /) -> Self:
    ...
    @classmethod
    def list_builder(cls) -> GenericListBuilder["APIServiceSpec", Builder]:
        return GenericListBuilder[APIServiceSpec, APIServiceSpec.Builder]()
    ...
    "GroupPriorityMinimum is the priority this group should have at least. Higher priority means that the group is preferred by clients over lower priority ones. Note that other versions of this group might specify even higher GroupPriorityMinimum values such that the whole group gets a higher priority. The primary sort is based on GroupPriorityMinimum, ordered highest number to lowest (20 before 10). The secondary sort is based on the alphabetical comparison of the name of the object.  (v1.bar before v1.foo) We\u0027d recommend something like: *.k8s.io (except extensions) at 18000 and PaaSes (OpenShift, Deis) are recommended to be in the 2000s"
    insecure_skip_tls_verify: Annotated[bool | None, Field(alias="insecureSkipTLSVerify")] = None
    "InsecureSkipTLSVerify disables TLS certificate verification when communicating with this server. This is strongly discouraged.  You should use the CABundle instead."
...
class APIService(Resource):
    ...
    class Builder(BaseModelBuilder):
        ...
        def api_version(self, value: Literal["apiregistration.k8s.io/v1"], /) -> Self:
            "APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources"
            return self._set("api_version", value)

        def kind(self, value: Literal["APIService"], /) -> Self:
            "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds"
            return self._set("kind", value)

        @overload
        def metadata(self, value_or_callback: ObjectMeta | None, /) -> "APIService.Builder": ...
        ...
        @overload
        def spec(self, value_or_callback: APIServiceSpec | None, /) -> "APIService.Builder": ...
        ...
        @overload
        def status(self, value_or_callback: APIServiceStatus | None, /) -> "APIService.Builder": ...
    ...
    @classmethod
    def list_builder(cls) -> GenericListBuilder["APIService", Builder]:
        return GenericListBuilder[APIService, APIService.Builder]()

    api_version: Annotated[Literal["apiregistration.k8s.io/v1"], Field(alias="apiVersion")] = (
